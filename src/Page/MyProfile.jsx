    ...
    return (
        <div>
            <div className="flex flex-col justify-center w-1/2 mx-auto p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-50 dark:text-gray-800">
                {/* <img src={user?.photoURL} alt="" className="w-32 h-32 mx-auto rounded-full  relative dark:bg-gray-500 aspect-square" />
                <img className="w-20 h-20 mr absolute" src="https://www.iconpacks.net/icons/1/free-badge-icon-1361-thumb.png" alt="" /> */}
            ...
            <div className="text-center mt-8">
                <h1 className="text-5xl font-bold">Your Last Posts</h1>
            ...
            <div className="w-1/2 mx-auto ">
                {
                    posts.slice(-3).reverse().map(post => <div key={post._id} className="mt-12 mb-7 shadow-xl">
                        <a
                            href="#"
                        ...
                        >
                            ...
                            <dl className="mt-6 flex gap-4 sm:gap-6">
                                <div className="flex flex-col-reverse">
                                    ...
                                    <dd className="text-xs text-gray-500">{post.time.slice(0, 10)}</dd>
                                </div>
