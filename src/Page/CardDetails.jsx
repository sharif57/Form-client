...
//         e.preventDefault();
//         const form = e.target;
//         const newVote = form.vote.value; 
//         console.log(newVote);

//         if (newVote === 'like') {
//             const like = items.upVote + 1;
//             const vote = like + items.downVote;
//             console.log(like, vote, );

//             console.log('User voted like', vote, like);
//         } 
//         else if (newVote === 'dislike') {
        
//             console.log('User voted dislike');
//         }
//     };
...
//                             <button value={'like'} name="vote" className="flex items-start justify-center">
//                                 <AiFillLike className="size-7" />
//                                 {/* {items.upVote} */}
//                     {/* </button>
//                             <button value={'disLike'} name="vote" className="flex items-start justify-center">
...
//                     <form onSubmit={handleVote}>
//                         <div className="flex gap-6 items-center mt-6">
//                             <button type="submit" value="like" name="vote" className="flex items-start justify-center">
//                                 <AiFillLike className="size-7" />
//                                 {items.upVote}
//                             </button>
//                             <button type="submit" value="dislike" name="vote" className="flex items-start justify-center">
//                                 <AiFillDislike className="size-7" />
//                                 {items.downVote}
//                             </button>
//                         </div>
...
const CardDetails = () => {
    ...
    const [userVote, setUserVote] = useState(null); // null means no vote, 'up' means upvoted, 'down' means downvoted
