...
//         return { name: data.comment, value: data. }
//     })
...
//         <div className="stat-value text-secondary">{comment.length}</div>
//     </div>
...
const AdminProfile = () => {
    ...
    const pieChartData = [
        ...
        { name: 'Comments', value: comment.length },
    ...
    return (
        <div>
            <div className="flex justify-around items-center gap-16">
                <div className="p-6 w-1/2 sm:p-12 dark:bg-green-100 dark:text-gray-800 shadow-2xl bg-green-100">
                    ...
                    <div className="flex justify-center pt-4 space-x-4 align-center">
                        ...
                        <a rel="noopener noreferrer" href="#" aria-label="Behance" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-violet-600">
            ...
            <div className="shadow-2xl mt-8">
                <h2 className="text-center text-2xl font-bold mb-5">Data Insights</h2>
