...
//     return (
//         <div className="">
//             <div className="h-full p-3 space-y-2 w-60 dark:bg-gray-50 dark:text-gray-800 mt-4 bg-slate-800">
...
//     </li>
//     <li>
//         {/* <NavLink to={'/dashboard/manageUsers'} rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
//             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-600">
...
//     </li>
//     <li>
//         <NavLink to={'/dashboard/reported'} rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
//             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-600">
...
import { FaAd, FaCalendar, FaHome, FaList, FaPhone, FaSearch, FaShoppingCart, FaUsers, FaUtensils } from "react-icons/fa";
                ...
                <ul className="menu p-4">
                    {
                        isAdmin ? <>
                            <li>
                                ...
                                <NavLink to={'/dashboard/myProfile'}><FaHome></FaHome>Admin Profile</NavLink>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <NavLink to={'/dashboard/myPost'}><FaShoppingCart></FaShoppingCart> Reported Comments </NavLink>
                            </li>
                            <li>
